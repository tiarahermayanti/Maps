...
import com.mobile.tiara.belajarmaps.helper.DirectionMapsV2;
import com.mobile.tiara.belajarmaps.helper.GPStrack;
import com.mobile.tiara.belajarmaps.helper.HeroHelper;
import com.mobile.tiara.belajarmaps.helper.MyFunction;
import com.mobile.tiara.belajarmaps.model.Distance;
import com.mobile.tiara.belajarmaps.model.Duration;
import com.mobile.tiara.belajarmaps.model.LegsItem;
import com.mobile.tiara.belajarmaps.model.RoutesItem;
import com.mobile.tiara.belajarmaps.network.ApiService;
import com.mobile.tiara.belajarmaps.network.RetrofitConfig;
...
public class MapsActivity extends MyFunction implements OnMapReadyCallback {
    ...
    //memeriksa status gps sudah aktif atau tidak
    ...
    //untuk mendapatkan detal alamatdar lattude dan longtude yangddapatkan
    ...
    //untuk menangkap result dar aksi intent
    @Override
    ...
    private void aksesrute() {
        ...
        //mengirim request
        Call<com.mobile.tiara.belajarmaps.model.Response>wayponitCall = api.request_route(
                edtawal.getText().toString(),
                edtakhir.getText().toString(),
                key
        );

        wayponitCall.enqueue(new Callback<com.mobile.tiara.belajarmaps.model.Response>() {
            @Override
            public void onResponse(Call<com.mobile.tiara.belajarmaps.model.Response> call, Response<com.mobile.tiara.belajarmaps.model.Response> response) {
            ...
            @Override
            public void onFailure(Call<com.mobile.tiara.belajarmaps.model.Response> call, Throwable t) {
